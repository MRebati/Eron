...
namespace Eron.Presentation.WebApplication.WebApi.App_Start
{
    ...
    public static class NinjectWebCommon
    {
        ...
        {
            kernel.Load(new SharedKernel.DependancyResolver.BusinessModules.ApplicationModule());
        }
        ...
        {
            kernel.Load(new SharedKernel.DependancyResolver.DataAccessModules.UnitOfWorkModule());
        }
        ...
        {
            kernel.Load(new SharedKernel.DependancyResolver.DataAccessModules.RepositoriesModule());
        }
    }
}
