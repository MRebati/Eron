...
export class Api {
  ...
  static settings = {
    default: base + 'appsettings/',
    client: base + 'appsettings/client/',
  };
  ...
  static insight = {
    ...
    getLastMonthSalesWithDayByDayDetails:
      base + 'insight/GetLastMonthSalesWithDayByDayDetails/',
    getCurrentMonthSalesWithDayByDayDetails:
      base + 'insight/GetCurrentMonthSalesWithDayByDayDetails/'
  };
