...
intEronense.redirectDefinition(jQuery.Callbacks, _1228819969);
...
intEronense.redirectDefinition(jQuery.Callbacks, _731531622);

intEronense.annotate(jQuery.Event.prototype, {
...
intEronense.annotate(jQuery.fn, {
  'add': function() {
    /// <signature>
